...
CATEGORY_DATE_TIMESTAMP = "Date and Timestamp"
CATEGORY_REORDERING = "Reordering"
CATEGORY_BUILD_PACKAGING_METADATA = "Build and Packaging Metadata"
CATEGORY_BUILD_ENVIRONMENT = "Build Environment"
CATEGORY_SBOM_DEPENDENCY = "SBOM and Dependency Metadata"
CATEGORY_FILES_ADDED_REMOVED = "Files Added or Removed"
CATEGORY_JVM_BYTECODE = "Java Class File"
CATEGORY_OTHER_FILE_CHANGES = "Other File Differences"
CATEGORY_HASH_CHANGES = "Hash Differences"
CATEGORY_UNKNOWN_CHANGES = "Unknown Differences"
...
CHANGE_TYPE_TO_CATEGORY: Dict[ChangeType, str] = {
    ...
    BUILDINFO_CHANGE: CATEGORY_BUILD_PACKAGING_METADATA,
    UNKNOWN_MANIFEST_CHANGE: CATEGORY_BUILD_PACKAGING_METADATA,
    MANIFEST_CHANGE: CATEGORY_BUILD_PACKAGING_METADATA,
    MANIFEST_REORDER_CHANGE: CATEGORY_BUILD_PACKAGING_METADATA,
    POM_CHANGE: CATEGORY_BUILD_PACKAGING_METADATA,

    # Java Class file changes
    CLASS_FILE_CHANGE: CATEGORY_JVM_BYTECODE,
    CLASS_LINE_NUMBER_CHANGE: CATEGORY_JVM_BYTECODE,
    GENERATED_ID_CHANGE: CATEGORY_JVM_BYTECODE,
    ...
    # Reordering
    FILE_REORDERED_CHANGE: CATEGORY_REORDERING,
    LINE_ORDERING_CHANGE: CATEGORY_REORDERING,
    WORD_ORDERING_CHANGE: CATEGORY_REORDERING,

    # Other file changes
    JAVASCRIPT_CHANGE: CATEGORY_OTHER_FILE_CHANGES,
    JSON_DIFF_CHANGE: CATEGORY_OTHER_FILE_CHANGES,
    JANDEX_CHANGE: CATEGORY_OTHER_FILE_CHANGES,
