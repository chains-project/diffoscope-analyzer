...
CATEGORY_BUILD_MANIFEST = "Build manifest changes"
...
CHANGE_TYPE_TO_CATEGORY: Dict[ChangeType, str] = {
    ...
    UNKNOWN_MANIFEST_CHANGE: CATEGORY_BUILD_MANIFEST,
    MANIFEST_CHANGE: CATEGORY_BUILD_MANIFEST,
    MANIFEST_REORDER_CHANGE: CATEGORY_BUILD_MANIFEST,
    ...
    GENERATED_ID_CHANGE: CATEGORY_NON_DETERMINISTIC,
    FILE_REORDERED_CHANGE: CATEGORY_NON_DETERMINISTIC,
    LINE_ORDERING_CHANGE: CATEGORY_NON_DETERMINISTIC,
    WORD_ORDERING_CHANGE: CATEGORY_NON_DETERMINISTIC,
    JANDEX_CHANGE: CATEGORY_NON_DETERMINISTIC,
